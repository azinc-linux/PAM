...
**2 наделить конкретного пользователя правами root. В моем случае это пользователь third. Для этого был создан файл  /etc/sudoers.d/third c 
    записью привелегий для перехода по sudo -s без пароля
